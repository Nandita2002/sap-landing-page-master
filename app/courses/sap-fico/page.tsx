    ...
    try {
      ...
      const res = await fetch(FORM_ENDPOINT, {
        ...
        body: JSON.stringify({
          ...
          goal: "SAP FICO syllabus download",
          source: "popup",
        }),
      });
      ...
      if (data.status === "success") {
        ...
        link.href = "/SAP_FICO_syllabus_RiseInfotech.pdf";
        link.download = "SAP_FICO_syllabus_RiseInfotech.pdf";
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              <SAP /> FICO (Financial Accounting and Controlling) is one of the
              most important modules in the <SAP /> ERP ecosystem used for
              managing financial transactions, reporting, and internal cost
              control processes.
              <br />
              <br />
              It helps organizations streamline accounting operations, generate
              financial statements, manage profitability, and ensure compliance
          ...
          <div className="rounded-2xl overflow-hidden aspect-[4/3] shadow-md relative">
            <Image
              src="/sapfico.jpg"
              alt="SAP FICO course module illustration"
              fill
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 p-8 md:p-12 text-center text-white shadow-xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-semibold mb-3">
              Download <span className="text-blue-100">SAP</span> FICO
              Syllabus
            </h2>

            <p className="text-white/80 text-sm md:text-base mb-6">
              Get the complete syllabus, module breakdown, real-time projects,
              tools covered, and career roadmap instantly.
            </p>
