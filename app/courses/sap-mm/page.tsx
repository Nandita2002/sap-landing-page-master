  ...
  const handleBrochureSubmit = async (
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        link.href = "/SAPMM_syllabus_Rise_Infotech.pdf";
        link.download = "SAPMM_syllabus_Rise_Infotech.pdf";
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              <SAP /> MM (Materials Management) is one of the core modules in
              the <SAP /> ERP system used for procurement, inventory
              management, material planning, and warehouse management.
              <br />
              <br />
              It helps organizations streamline supply chain operations,
              optimize procurement cycles, and maintain efficient inventory
          ...
          <div className="rounded-2xl overflow-hidden aspect-[4/3] shadow-md relative">
            <Image
              src="/sapmm.jpg"
              alt="SAP MM course module illustration"
              fill
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 p-8 md:p-12 text-center text-white shadow-xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-semibold mb-3">
              Download <span className="text-blue-100">SAP</span> MM
              Syllabus
            </h2>

            <p className="text-white/80 text-sm md:text-base mb-6">
              Get the complete syllabus, module breakdown, procurement flow,
              inventory process, and project roadmap instantly.
            </p>
